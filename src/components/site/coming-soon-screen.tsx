 ...
 * own path.
 *
 * No nav, no footer, no links out. It announces the 2026 theme and
 * nothing else — no date, venue, ticket link or email capture — so
 * there is deliberately nothing here to click.
 *
