 ...
 *
 * So the height limit is converted into a width instead. `95cqh` is
 * `50cqh × 2557/1352` — the same vertical bound, expressed on the axis that
 * can carry it alongside the other two caps: `100%` keeps the bowl clear of
 * the walls on a tall narrow window, and 900px is its ceiling (checked
 * against a 1920×1080 desktop, where the previous 580px ceiling was what
